...
extern uint32_t REQUEST_OF_BLOCKS_IN_PHASE_REQUEST_INDIVIDUAL_EACH_MILLISECONDS;
...
extern uint32_t PRINT_CONSENSUS_MESSAGE;
...
extern uint32_t TX_NUMBERS_IN_A_BLOCK;
//
