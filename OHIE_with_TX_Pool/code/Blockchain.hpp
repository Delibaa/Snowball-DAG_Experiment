...
public:
	...
	int get_mined_block_numbers();
	void update_blocks_commited_time();
	int get_number_of_pool_block();

	// transaction pool signal
	int number_of_pool_block;
	vector<int> received_numbers_of_pool;
